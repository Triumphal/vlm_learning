...
from src.data import LlavaDataset, TrainLlavaModelCollator
...
class ModelArguments:
    model_name_or_path: Optional[str] = field(default="models/llava_clip-L-14-336_Qwen1.5-1.8B")
...
def load_model_processor(modelargs: ModelArguments):
    ...
    if modelargs.train_type == "use_lora":
        ...
        config = LoraConfig(
            ...
            bias="none",
            task_type="CAUSAL_LM",
            modules_to_save=["multi_modal_projector"], # WARNNING
        )
