...
# output_pretrain_data = "./datasets/seq_monkey_datawhale.jsonl"
...
#         data = f.readlines()
#         for line in tqdm(
#             data, desc=f"Processing lines in {pretrain_data}", leave=False
#         ):  # 添加行级别的进度条
...
output_sft_data = "./datasets/BelleGroup/BelleGroup_sft.jsonl"
